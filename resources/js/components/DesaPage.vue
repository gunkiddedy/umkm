    ...
    data() {
        return {
            ...
            columns: [
                ...
                {label: 'up1',field: 'up1', sortable: true, width: '120px'},
                {label: 'up2',field: 'up2', sortable: true, width: '120px'},
                {label: 'up3',field: 'up3', sortable: true, width: '120px'},
                {label: 'up4',field: 'up4', sortable: true, width: '120px'},
                {label: 'up5',field: 'up5', sortable: true, width: '120px'},
